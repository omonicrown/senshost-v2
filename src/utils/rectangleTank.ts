...
export interface Config {
  tankType?: string;
  tankWidth?: any; // outside width.
  tankHeight?: any; // outside height.
  fillPadding?: any; // gap between perimeter and inside tank area that displays water.
  borderWidth?: number; // perimeter width.
  borderColor?: string; // outside border color. usually the perimeter of the tank
  defaultFillColor?: string; // default water color. this is assigned to fillColor if water level does not pass any thresholds.
  fillColor?: any; // used later to set water color. it could be different color depending on situations.
  backFillColor?: string; // background color inside the tank where there is no water.
  backFillOpacity?: number; // opacity of the background.
  innerCornerRadius?: number;
  borderCornerRadius?: number;
  innerWidth?: number;
  innerHeight?: number;
  neckWidth?: number; // only applies to round tank
  neckHeight?: number; // only applies to round tank
  fillAnimationColor?: string; // used later to set the color while animating.
  fillMaxValue?: number; // maximum possible value for the main text.
  fillMinValue?: number; // minimum possible value for the main text.
  fillValue?: any; // value used to display the main text.
  fillUnit?: string; // unit that is appended to the main text.
  decimal?: number; // number of decimal places for the main text.
  overlayTextFillOpacity?: number; // opacity of the main text.
  arrow?: boolean; // arrow that is displayed to the right of the main text.
  fontFamily?: string;
  fontWeight?: string;
  fontSize?: number;
  backFontColor?: any;
  backFontAnimationColor?: string;
  frontFontColor?: string;
  waveWidth?: number;
  amplitude?: number;
  horizontalWaveDuration?: number;
  transitionDuration?: number;
  delay?: 0;
  ease?: any;
  marker?: true;
  markerPosition?: string;
  markerGap?: Array<number>;
  markerLabelXOffset?: number;
  markerLabelYOffset?: number;
  markerWidth?: number;
  markerLength?: number;
  topMarkerText?: any;
  topMarkerColor?: string;
  topMarkerFontColor?: string;
  bottomMarkerText?: any;
  bottomMarkerColor?: string;
  bottomMarkerFontColor?: string;
  markerFontSize?: number;
  markerFontWeight?: number;
  markerFontFamily?: number;
  enableSupportLabel?: boolean;
  supportLabelFontColor?: string;
  supportLabelFontFamily?: string;
  supportLabelFontWeight?: string;
  supportLabelFontSize?: number;
  supportLabelText?: string;
  supportLabelYOffset?: number;
  mergeSupportLabelToBorder?: false;
  dualSupportLabel?: false;
  topSupportLabelFontColor?: string;
  topSupportLabelFontFamily?: string;
  topSupportLabelFontWeight?: string;
  topSupportLabelFontSize?: number;
  topSupportLabelText?: string;
  topSupportLabelYOffset?: number;
  enableSupportLabelBg?: boolean;
  supportLabelBackgroundColor?: string;
  supportLabelBackgroundOpacity?: number;
  supportLabelBackgroundHeight?: number;
  supportLabelBackgroundWidth?: number;
  supportLabelBackgroundBorderWidth?: number;
  supportLabelBackgroundBorderColor?: string;
  supportLabelPadding?: number;
  supportLabelWidthFix?: number;
  arrowName?: string;
  upArrowName?: string;
  downArrowName?: string;
  noArrowName?: string;
  arrowFontFamily?: string;
  arrowFontWeight?: string;
  arrowFontSize?: number;
  arrowXOffset?: number;
  arrowYOffset?: number;
  topFillBackArrowColor?: string;
  bottomFillBackArrowColor?: string;
  frontArrowColor?: string;
  backArrowColor?: string;
  markerBarXOffset?: number;
  tooltipFontSize?: number;
  thresholds?: Array<object>;
  lookupTableValue?: number; // if lookup table value is set, a secondary text is displayed under the main text.
  lookupTableValueUnit?: string; // unit for lookupTableValue.
  lookupTableValueDecimal?: number; // number of decimal places for lookup table value.
  lookupTableValueEnabled?: boolean;
  lookupTableValueFontSize?: number;
  lookupTableValueYOffset?: number;
  changeRateValueArrowEnabled?: boolean;
  changeRateValueArrowYOffset?: number;
  changeRateValue?: string;
  changeRateValueDecimal?: number;
  changeRateValueEnabled?: boolean;
  changeRateValueFontSize?: number;
  changeRateValueYOffset?: number;
  changeRateValueUnit?: string;
}
export class AnalogTank {
  private container: HTMLDivElement;
  private url: string;
  private svgContainer: any;
  private bodyGroup: any;
  private gaugeScale: any;

  private tankGroup: any;
  private width!: number;
  private height!: number;

  private newHeight!: number;
  private waveClip!: any;
  private waveHorizontal!: any;

  private backFill: any;
  private border: any;
  private behindText: any;
  private behindArrow: any;
  private lookupTableValueBehindText: any;
  private changeRateValueBehindText: any;
  private changeRateValueOverlayText: any;

  private waveGroup: any;
  private waterFill: any;
  private lookupTableValueOverlayText: any;
  private overlayText: any;
  private overlayArrow: any;

  private supportLabelGroup: any;
  private supportLabelBg: any;
  private supportLabel: any;
  ...
  private innerRx: any;
  private innerRy: any;
  private markerBar: any;

  private thresholdMarkerPositions: any;
  private thresholdTooltips: any;
  private thresholdMarkers: any;

  private tankType!: string;
  private tankWidth: any; // outside width.
  private tankHeight: any; // outside height.
  private fillPadding: any; // gap between perimeter and inside tank area that displays water.
  private borderWidth!: number; // perimeter width.
  private borderColor!: string; // outside border color. usually the perimeter of the tank
  private defaultFillColor!: string; // default water color. this is assigned to fillColor if water level does not pass any thresholds.
  private fillColor!: string; // used later to set water color. it could be different color depending on situations.
  private backFillColor!: string; // background color inside the tank where there is no water.
  private backFillOpacity!: number; // opacity of the background.
  private innerCornerRadius!: number;
  private borderCornerRadius!: number;
  private innerWidth!: number;
  private innerHeight!: number;
  private neckWidth!: number; // only applies to round tank
  private neckHeight!: number; // only applies to round tank
  private fillAnimationColor!: string; // used later to set the color while animating.
  private fillMaxValue!: number; // maximum possible value for the main text.
  private fillMinValue!: number; // minimum possible value for the main text.
  private fillValue!: any; // value used to display the main text.
  private fillUnit!: string; // unit that is appended to the main text.
  private decimal!: number; // number of decimal places for the main text.
  private overlayTextFillOpacity!: number; // opacity of the main text.
  private arrow!: boolean; // arrow that is displayed to the right of the main text.
  private fontFamily!: string;
  private fontWeight!: string;
  private fontSize!: number;
  private backFontColor!: any;
  private backFontAnimationColor!: string;
  private frontFontColor!: string;
  private waveWidth!: number;
  private amplitude!: number;
  private horizontalWaveDuration!: number;
  private transitionDuration!: number;
  private delay!: number;
  private ease!: any;
  private marker!: true;
  private markerPosition!: string;
  private markerGap!: Array<number>;
  private markerLabelXOffset!: number;
  private markerLabelYOffset!: number;
  private markerWidth!: number;
  private markerLength!: number;
  private topMarkerText!: any;
  private topMarkerColor!: string;
  private topMarkerFontColor!: string;
  private bottomMarkerText!: any;
  private bottomMarkerColor!: string;
  private bottomMarkerFontColor!: string;
  private markerFontSize!: number;
  private markerFontWeight!: number;
  private markerFontFamily!: number;
  private enableSupportLabel!: boolean;
  private supportLabelFontColor!: string;
  private supportLabelFontFamily!: string;
  private supportLabelFontWeight!: string;
  private supportLabelFontSize!: number;
  private supportLabelText!: string;
  private supportLabelYOffset!: number;
  private mergeSupportLabelToBorder!: false;
  private dualSupportLabel!: boolean;
  private topSupportLabelFontColor!: string;
  private topSupportLabelFontFamily!: string;
  private topSupportLabelFontWeight!: string;
  private topSupportLabelFontSize!: number;
  private topSupportLabelText!: string;
  private topSupportLabelYOffset!: number;
  private enableSupportLabelBg!: boolean;
  private supportLabelBackgroundColor!: string;
  private supportLabelBackgroundOpacity!: number;
  private supportLabelBackgroundHeight!: number;
  private supportLabelBackgroundWidth!: number;
  private supportLabelBackgroundBorderWidth!: number;
  private supportLabelBackgroundBorderColor!: string;
  private supportLabelPadding!: number;
  private supportLabelWidthFix!: number;
  private arrowName!: string;
  private upArrowName!: string;
  private downArrowName!: string;
  private noArrowName!: string;
  private arrowFontFamily!: string;
  private arrowFontWeight!: string;
  private arrowFontSize!: number;
  private arrowXOffset!: number;
  private arrowYOffset!: number;
  private topFillBackArrowColor!: string;
  private bottomFillBackArrowColor!: string;
  private frontArrowColor!: string;
  private backArrowColor!: string;
  private markerBarXOffset!: number;
  private tooltipFontSize!: number;
  private thresholds!: Array<any>;
  private lookupTableValue!: number; // if lookup table value is set, a secondary text is displayed under the main text.
  private lookupTableValueUnit!: string; // unit for lookupTableValue.
  private lookupTableValueDecimal!: number; // number of decimal places for lookup table value.
  private lookupTableValueEnabled!: boolean;
  private lookupTableValueFontSize!: number;
  private lookupTableValueYOffset!: number;
  private changeRateValueArrowEnabled!: boolean;
  private changeRateValueArrowYOffset!: number;
  private changeRateValue!: string;
  private changeRateValueDecimal!: number;
  private changeRateValueEnabled!: boolean;
  private changeRateValueFontSize!: number;
  private changeRateValueYOffset!: number;
  private changeRateValueUnit!: string;

  private neckFill: any;
  private neckBorder: any;

  private neckBackFill: any;
  private backArrowAnimationColor: any;
  private supportLabelBgWidth: any;
  private supportLabelBgHeight: any;
  private supportLabelTrans: any;
  private clipWidth: any;
  private clipDef: any;
  private clipDefArray: any;
  private topSupportLabelTrans: any;
  private topFillColor: any;
  private topFillBackFontColor: any;
  private bottomFillColor: any;
  private bottomFillBackFontColor: any;
  ...
  constructor(element: HTMLDivElement, config: Config) {
    let defaults: Config = {
      ...
      fillAnimationColor: "", // used later to set the color while animating.
      ...
      fillUnit: "", // unit that is appended to the main text.
      ...
      supportLabelBackgroundHeight: 0,
      supportLabelBackgroundWidth: 0,
      supportLabelBackgroundBorderWidth: 1,
      supportLabelBackgroundBorderColor: "",
      ...
      arrowXOffset: 3,
      arrowYOffset: -1,
      topFillBackArrowColor: "",
      bottomFillBackArrowColor: "",
      frontArrowColor: "",
      backArrowColor: "",
      markerBarXOffset: 3,
      tooltipFontSize: 10,
      thresholds: [],
      lookupTableValue: 0, // if lookup table value is set, a secondary text is displayed under the main text.
      lookupTableValueUnit: "", // unit for lookupTableValue.
  ...
  calculateDimensions() {
    ...
    let markerGapSum = this.markerGap
      ? this.markerGap[0] + this.markerGap[1]
      : 0;
    ...
    this.thresholds?.forEach((threshold, i) => {
      ...
      if (this.thresholdMarkers.length > 0) {
        this.thresholdMarkerPositions.push({
          yCoord:
            (this.thresholdMarkers[i - 1].datum().yCoord + pixelPosition) / 2,
        });
      }
  ...
  applyFillAttributes() {
    if (this.tankType === "tower") {
      this.applyAttributes(this.backFill, {
        ...
        transform: `translate(-${(this.tankWidth - this.borderWidth) / 2}, -${
  ...
  applyTextAttributes() {
    ...
    this.applyAttributes(this.overlayText, {
      datum: {
        color: this.frontFontColor === null ? "#fff" : this.frontFontColor,
      },
      "text-anchor": "middle",
      "font-family": this.fontFamily,
      "font-size": `${this.fontSize}px`,
  ...
  calculateColor() {
    ...
    this.backArrowAnimationColor =
      this.backArrowColor === null ? this.fillColor : this.backArrowColor;
  }
  ...
  colorTransition(selection: any, attribute: any, targetColor: any) {
    selection
      .transition()
      .delay(this.delay)
      .duration(this.transitionDuration)
  ...
  textFormatter(val: any) {
    if (this.fillUnit) {
      return `${Number(
        Math.round((parseFloat(val) + "e" + this.decimal) as any) +
          "e-" +
          this.decimal
  ...
  lookupTextFormatter(val: any) {
    if (this.lookupTableValueUnit) {
      return `${Number(
        Math.round(
          (parseFloat(val) + "e" + this.lookupTableValueDecimal) as any
        ) +
          "e-" +
          this.lookupTableValueDecimal
      ).toFixed(this.lookupTableValueDecimal)} ${this.lookupTableValueUnit}`;
    }
    return `${Number(
      Math.round(
        (parseFloat(val) + "e" + this.lookupTableValueDecimal) as any
  ...
  changeRateValueTextFormatter(val: any) {
    if (this.changeRateValueUnit) {
      return `${Number(
        Math.round(
          (parseFloat(val) + "e" + this.changeRateValueDecimal) as any
        ) +
          "e-" +
          this.changeRateValueDecimal
      ).toFixed(this.changeRateValueDecimal)} ${this.changeRateValueUnit}`;
    }
    return `${Number(
      Math.round((parseFloat(val) + "e" + this.changeRateValueDecimal) as any) +
        "e-" +
        this.changeRateValueDecimal
  ...
  tweenText() {
    ...
    this.behindText
      ...
      .ease(this.ease)
      .duration(this.transitionDuration)
      .tween("text", function (this: HTMLInputElement, d: any) {
        let node = this;
  ...
  calculateArrowPosition() {
    ...
    if (this.changeRateValueArrowEnabled && this.changeRateValueEnabled) {
      ...
      xOffset =
        ...
        this.arrowXOffset;
      yOffset =
        this.overlayArrow.node().getBBox().height / 4 + this.arrowYOffset;
    }
  ...
  repositionMarker() {
    let topMarkerLabelTrans = `translate(${
      this.innerWidth / 2 + this.markerLabelXOffset - this.markerFontSize / 4
    }, -${
      this.innerHeight / 2 - this.markerFontSize + this.markerLabelYOffset
    })`;
    let bottomMarkerLabelTrans = `translate(${
      this.innerWidth / 2 + this.markerLabelXOffset - this.markerFontSize / 4
    }, ${
      this.innerHeight / 2 - this.markerFontSize / 4 + this.markerLabelYOffset
    })`;
  ...
  repositionSupportLabelGroup() {
    ...
    this.supportLabelGroup.attr(
      "transform",
      `translate(0, ${
        this.height / 2 - this.borderWidth - this.supportLabelBgHeight / 2
      })`
    );
  }
  ...
  repositionSupportLabelBg() {
    ...
    let labelDimensions: any = this.getSupportLabelDimensions();
    let requiredWidth =
      labelDimensions?.width +
      2 * this.supportLabelPadding +
      paddingForAesthetic;
    let requiredHeight = labelDimensions?.height + 2 * this.supportLabelPadding;
  ...
  applyAttributes(selection: any, datum = {} as any) {
  ...
  getXCoordOfEllipse(y: any) {
    return Math.sqrt(
      Math.pow(this.tankRx, 2) * (1 - Math.pow(y, 2) / Math.pow(this.tankRy, 2))
    );
  }

  getYCoordOfEllipse(x: any) {
    return Math.sqrt(
      Math.pow(this.tankRy, 2) * (1 - Math.pow(x, 2) / Math.pow(this.tankRx, 2))
    );
  }
  ...
  updateLookupTableValue(val: any) {
  ...
  setBisector() {
    this.bisector = d3.bisector(function (d: any) {
      return d.yCoord;
    }).left;
  }
  ...
  hover() {
    d3.select(this.svgContainer.node().parentNode).on("mouseleave", () => {
      this.thresholdMarkers.forEach((marker: any, i: number) => {
  ...
  insertFirstBeforeSecond(container: any, first: any, second: any) {
  ...
  insertFirstAfterSecond(container: any, first: any, second: any) {
    container.insert(
      function () {
        return first.node();
      },
  ...
  appendSecondElementToFirst(first: any, ...args: any) {
    args.forEach((arg: any) => first.append(() => arg.node())); // for each second argument, return a function: first.append( function(arg) { arg.node() });
  }
} // end of class
